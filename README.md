...
쿼리 작성 에이전트: 사용자 입력으로 검색 쿼리를 생성합니다.
<br>
서칭 에이전트: 사용자가 선택한 감정 태그와 쿼리를 보고 내용을 Vector DB에서 정확하게 검색하고 추출
<br>
추론 에이전트: 가사 생성 권장 사항을 도출
<br>
최종 생성 에이전트: 앞서 모든 과정을 거쳐 최종 가사를 생성
<br>
자기 검증 에이전트: 생성된 가사를 검증하고 개선
...
### 2. 생성된 노래
[음원 파일 듣기](https://github.com/user-attachments/files/24316193/zzongai_._.mp3)
